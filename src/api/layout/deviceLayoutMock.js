 ...
 * 统一 Layout 模拟数据工厂
 *
 * 提供统一的模拟数据生成函数，供所有 Layout 开发测试使用。
 * 生产环境此文件不会被引入。
 */
...
/**
 * 创建 Layout 模拟数据的 Promise
 * @param {any} data - 模拟数据
 * @returns {() => Promise} 返回模拟 API 函数
 */
export function createLayoutMockData(data) {
  return function () {
...
// ========================================================================
// Rework3F 模拟数据（从 device3F.js 迁移，保持兼容）
// ========================================================================

export const mockRework3FDevices = [
  // 点灯机OC区域 (4台)
...
export const mockRework3FAlarms = [
  {
    alarmId: 1,
    deviceCode: 'UV',
    deviceName: 'UV固化设备',
