<template>
  <div class="rework3f-dashboard">
    <!-- 顶部状态栏 -->
    <header class="dashboard-header">
      <div class="header-left">
        <h1 class="title">Rework 3F</h1>
      </div>
...
import { getDeviceStatusListMock, getRecentAlarmsMock } from '@/api/layout/device3F'
import rawSvg from './RW3F.svg?raw'
